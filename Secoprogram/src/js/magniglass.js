...
function magniglass(opt) {
    ...
    var main = document.getElementsByClassName('main')[0]; //原图
    var biger = document.getElementsByClassName('biger')[0]; //大图
    var smaller = document.getElementsByClassName('smaller')[0]; //大图
    var bigpic = document.getElementsByClassName('bigpic')[0]; //大图
    var smallpi = document.getElementsByClassName('smallpi')[0]; //大图
    // var main = document.getElementsByClassName('main')[0]; //大图
    var mask = document.getElementsByClassName('mask')[0]; //大图
    ...
    //2.经过原图：出现大图可视区和遮罩
    var mask = document.getElementsByClassName('mask')[0]; //遮罩
    ...
    //     }
    // }
    smaller.children[0].className = 'current';
    ...
    smaller.onmouseover = function (ev) {
        ...
        if (ev.target.tagName.toLowerCase() == 'img') {
            ...
            ev.target.parentNode.className = 'current';
        }
    }
